...
import { useGetStocksReturnQuery } from '../../Store/services/stocks'
import { useNavigate } from 'react-router'

const StocksReturn = () => {
  const { data: stocks, refetch } = useGetStocksReturnQuery()
  useEffect(() => {
    refetch()
  }, [refetch])
  ...
  const hadleStockInfo = (id_item: string) => {
    navigate(`/stocksReturnInfo/${id_item}`)
  }
  return (
    <Container>
